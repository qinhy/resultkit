start uv run .\examples\14_iox2_dai_yolo_web_mjpeg\servers\server_dai.py ---service-name OkadCamA --device 169.254.1.222
start uv run .\examples\14_iox2_dai_yolo_web_mjpeg\servers\server_yolo.py
start uv run .\examples\14_iox2_dai_yolo_web_mjpeg\servers\server_glshow.py
