...
@REM start "yolo" uv run .\examples\14_iox2_dai_yolo_web_mjpeg\servers\server_yolo.py
@REM start "pcd" uv run .\examples\14_iox2_dai_yolo_web_mjpeg\servers\server_pcd.py
