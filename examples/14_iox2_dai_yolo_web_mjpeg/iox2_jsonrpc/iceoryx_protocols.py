...
class ServerBuilder(Protocol):
    def initial_max_slice_len(self, length: int) -> ServerBuilder: ...

    def allocation_strategy(self, strategy: object) -> ServerBuilder: ...

    def create(self) -> Server: ...


class ClientBuilder(Protocol):
    def initial_max_slice_len(self, length: int) -> ClientBuilder: ...

    def allocation_strategy(self, strategy: object) -> ClientBuilder: ...
...
class RequestResponseBuilder(Protocol):
    def max_servers(self, value: int) -> RequestResponseBuilder: ...

    def max_clients(self, value: int) -> RequestResponseBuilder: ...

    def max_response_buffer_size(self, value: int) -> RequestResponseBuilder: ...

    def max_active_requests_per_client(self, value: int) -> RequestResponseBuilder: ...
